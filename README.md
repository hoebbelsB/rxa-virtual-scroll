...
```ts
import { FixedSizeVirtualScrollStrategy, RxVirtualScrollingModule } from '@rx-angular/virtual-scrolling';
...
Right now, the `@rx-angular-addons/virtual-scrolling` package only supports vertical scrolling. In the future, it should also
...
| Angular     | RxJS                 | @rx-angular-addons/virtual-scrolling |
| ----------- | -------------------- | ------------------------------------ |
